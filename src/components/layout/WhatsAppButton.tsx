...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {/* Button */}
      <span className="relative flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#20bd5a] hover:shadow-xl hover:scale-110 transition-all duration-300">
